/**
 * Model Context Protocol (MCP) 官方 logo。
 *
 * 与 browserLogos.tsx 相同的做法：SVG 直接内嵌为 React 组件，不依赖
 * 实体文件，避免打包路径问题。单色图形使用 currentColor，跟随周围
 * 文字颜色，与 lucide 图标视觉保持一致。
 * 图标源：simple-icons（modelcontextprotocol）。
 */
...
export const McpLogo = ({
  size = 16,
  className,
}: McpLogoProps): React.JSX.Element => (
  <svg
    className={className}
    height={size}
    viewBox="0 0 24 24"
